...
This is Part 3 of 3 for the final project for the University of Washington Professional and Continuing Education Data Science certificate class #3 of 3.  I chose the Kaggle competition "How Much Did it Rain" (https://www.kaggle.com/c/how-much-did-it-rain-ii).  I did not work with any team members for this project.
...
- link to note about re-scoring the competition.
...
```{r final_gbm_model}
mygbm <- readRDS('./gbm_mod_500_4_0.05.rds')
summary(mygbm)
```
